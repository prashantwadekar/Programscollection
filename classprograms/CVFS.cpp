...
void man(char *name)
{
    ...
    {
        printf("Description : Used to ctreate new regular file\n");
...
int fstat_file(int fd)
{
    ...
    printf("\n-----------Statical Informaton About File------------\n");
    printf("File Name : %s\n",temp->FileName);
...
int main()
{
    ...
    while(1)
    {
        ...
        if(count==1)
        {
            ...
            {
                printf("Terminating the Marvellous CVFS\n");
                break;
            }
            else
            {
        ...
        else if(count==2)
        {
            ...
            else if(strcmp(command[0],"write")==0)
            {
                ...
                if(ret==-2)
                    printf("Error : There is no suffisient memory to write\n");
                if(ret==-3)
        ...
        else if(count==3)
        {
            if(strcmp(command[0],"create")==0)
            {
                ...
                if(ret>=0)
                    printf("File is successfullu created with file descriptor : %d\n",ret);
                if(ret==-1)
                    printf("Error : Incorrect Parameters\n");
                if(ret==-2)
                    printf("Error : There is no such file\n");
            ...
            else if(strcmp(command[0],"read")==0)
            {
                ...
                if(ret==-2)
                    printf("Error : Permission Denied\n");
                if(ret==-3)
                    printf("Error : Reached ata end of file\n");
                if(ret==-4)
                    printf("Error : It is not regular file\n");
                if(ret==0)
