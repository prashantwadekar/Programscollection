...
void man(char *name)
{
    ...
    if(strcmp(name,"create")==0)
    {
        ...
        printf("Usage:create File_name Permisson\n");
    }
    ...
    else if(strcmp(name,"write")==0)
    {
        ...
        printf("Usage:write File_name\nAfter this enter the data that you want to wrie\n");
    }
...
void DisplayHelp()
{
    ...
    printf("exist:To Terminate filesystem\n");
...
int fstat_file(int fd)
{
    ...
    if(temp->Permission==3)
         printf("File Permisson:Read and Write\n");
    ...
    while(1)
    {
        ...
        else if(count==2)
        {
            ...
            else if(strcmp(command[0],"write")==0)
            {
                ...
                if(ret==-1)
                {
                    printf("Error:permisson defined\n");
                }
                if(ret==-2)
                {
